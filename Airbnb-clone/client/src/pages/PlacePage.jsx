...
const PlacePage = () => {
    ...
    if (showAllPhotos) {
        return (
            <div className="absolute inset-0 bg-black text-white min-h-screen z-10">
            ...
            <div className="relative">
                <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
                    <div>
                        {place.photos?.[0] && (
                            <div>
                                <img onClick={() => setShowAllPhotos(true)} className="cursor-pointer hover:opacity-90 aspect-square object-cover w-full" src={`${place.photos[0]}`} alt="" />
                            </div>
                        )}
                    </div>
                    <div className="grid">
                        {place.photos?.[1] && (
                            <img onClick={() => setShowAllPhotos(true)} className="cursor-pointer hover:opacity-90 aspect-square object-cover w-full" src={`${place.photos[1]}`} alt="" />
                        )}
                        <div className="overflow-hidden">
                            {place.photos?.[2] && (
                                <img onClick={() => setShowAllPhotos(true)} className="cursor-pointer hover:opacity-90 aspect-square object-cover relative top-2 w-full" src={`${place.photos[2]}`} alt="" />
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-5 my-4">
                        ...
                        <div className="flex gap-1 items-center">
                            ...
                            <h1 className="text-lg">{place.guests}</h1>
                        </div>
                    </div>
                    <hr />
                    <h2 className="font-semibold text-2xl mt-3">Perks</h2>
                    <div className="grid grid-cols-3 mt-3 gap-2 mb-6">
                    ...
                    <div>
                        <hr />
                        <h2 className="font-semibold text-2xl mt-3">Type</h2>
                        {place?.type && (
                            <div type="button" className={`w-56 border my-3 py-2 px-3 rounded-2xl transition flex items-center justify-center gap-2`}>
                                {place.type === "house" && (
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
