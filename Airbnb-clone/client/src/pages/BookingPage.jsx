                ...
                {booking?.place?.extraInfo && (
                    <div className="border-r pr-5 ">
                        <div className="">
                            ...
                            <div className="mt-3 text-sm text-gray-700 leading-5">{booking?.place?.extraInfo}</div>
                        </div>
                    </div>
                )}
                <div>
                    ...
                    <div className="flex flex-col mt-2">
                        {booking?.place?.reviews?.map((review, index) =>
                            <div className="flex gap-2 text-sm text-gray-700 leading-5" key={index}>
                                ...
                                <p className="">{booking?.place?.review?.reviewText}</p>
                            </div>
                        )}
                    </div>
                </div>
