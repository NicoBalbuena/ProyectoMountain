            ...
            {booking?.place?.photos?.[0] && (
              <div>
                <img
                  ...
                  className="cursor-pointer hover:opacity-90 aspect-square object-cover w-full"
          ...
          <div className="grid">
            ...
            <div className="overflow-hidden">
              {booking?.place?.photos?.[2] && (
                <img
                  onClick={() => setShowAllPhotos(true)}
                  className="cursor-pointer hover:opacity-90 aspect-square object-cover relative top-2 w-full"
      ...
      <div>
                    ...
                    <div className="flex items-center gap-5 my-4">
                        ...
                        <div className="flex gap-1 items-center">
                            ...
                            <h1 className="text-lg">{booking.place?.guests}</h1>
                        </div>
                    </div>
                    <hr />
